...
class FastAPIServer(BaseAppServer):
    ...
    def _get_current_api_parameters(self, **kwargs) -> dict:
        api_params_info: List[APIParameter] = self.mock_api_details[self._get_current_api_path(kwargs["request"])][self._get_current_request_http_method(kwargs["request"])].http.request.parameters  # type: ignore[union-attr]
