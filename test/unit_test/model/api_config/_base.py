...
from fake_api_server.model import HTTP, MockAPI, MockAPIs
...
from fake_api_server.model.api_config.format import Format, _HasFormatPropConfig
        ...
        with patch(f"{_get_abs_module(sut)}.should_divide", new_callable=PropertyMock) as mock_should_divide:
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch("fake_api_server.model.api_config.template._divide.YAML.write") as mock_yaml_write:
