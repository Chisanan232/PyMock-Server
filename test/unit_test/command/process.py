...
class TestSubCmdCheck(BaseCommandProcessorTestSpec):
    ...
    def test_with_run_entry_point_of_diff_swagger(
        self,
        api_resp_path: str,
        dummy_yaml_path: str,
        stop_if_fail: bool,
    ...
    def _test_process_of_diff_swagger(
        ...
        with patch("pymock_api.command.process.load_config") as mock_load_config:
    ...
    def test__get_swagger_config(self, swagger_config_response: str, cmd_ps: SubCmdCheck):
        with patch("pymock_api.command.process.URLLibHTTPClient.request") as mock_api_client_request:
