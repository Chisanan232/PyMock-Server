...
from pymock_server.model import APIConfig, MockAPIs, load_config
    ...
    def __init__(
        ...
        Args:
            ...
            app_server (BaseAppServer): Which web application to use to set up the web application to mock APIs. In
                generally, it must be the *pymock_server.application.BaseAppServer* type object. In default, it would use
        ...
        if app_server and not isinstance(app_server, BaseAppServer):
            raise TypeError(f"The instance {app_server} must be *pymock_server.application.BaseAppServer* type object.")
        if not app_server:
    ...
    def create_apis(self, mocked_apis: MockAPIs) -> None:
        ...
        Args:
            mocked_apis (MockAPIs): The data object of mocked APIs configuration which be generated by utility function
                *pymock_server._utils.load_config*.
