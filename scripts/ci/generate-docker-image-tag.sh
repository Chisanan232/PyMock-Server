...
do
     case $argv in
         ...
         "h")    # Help for display all usage of each arguments
           ...
           echo "  -h [Argument]                  Show this help. You could set a specific argument naming to show the option usage. Empty or 'all' would show all arguments usage. [options: r, p, v, h]"
           exit
           ;;
         ?)
